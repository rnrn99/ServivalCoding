...
import {Tech} from "../db/models/Tech.js";
...
techRouter.post(
  ...
  async function (req, res, next) {
    ...
    try {
      ...
      const toPost = fieldChecking(req.body, "confident", "favorite", "languages", "frameworks", "tools");
...
techRouter.put(
  ...
  async function (req, res, next) {
    ...
    try {
      // 업데이트할 정보를 묶어서
      const toUpdate = fieldChecking(req.body, "confident", "favorite", "languages", "frameworks", "tools");
